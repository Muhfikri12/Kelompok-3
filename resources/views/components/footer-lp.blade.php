        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-md-6 col-lg-6 col-xl-3">
                    <h3>Halaman Menu</h3>
                    <div class="footer-item d-flex flex-column">
                        <a href="{{ route('about-us') }}" class="text-light"><i
                                class="fa fa-angle-right me-2"></i>Tentang Kami</a>
                        <a href="{{ route('visi-misi') }}" class="text-light"><i class="fa fa-angle-right me-2"></i>
                            Visi & Misi</a>
                        <a href="{{ route('sejarah') }}" class="text-light"><i class="fa fa-angle-right me-2"></i>
                            Sejarah</a>
                        <a href="{{ route('data-demografi') }}" class="text-light"><i
                                class="fa fa-angle-right me-2"></i> Demografi</a>
                        <a href="{{ route('data-geografi') }}" class="text-light"><i
                                class="fa fa-angle-right me-2"></i> Geografi</a>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6 col-xl-3">
                    <h3>Manajemen Desa</h3>
                    <div class="footer-item d-flex flex-column">
                        ...
                        <a href="{{ route('struktur') }}" class="text-light"><i
                                class="fas fa-angle-right me-2"></i>Struktur Organisasi</a>
                        <a href="{{ route('data-lembaga') }}" class="text-light"><i
                                class="fas fa-angle-right me-2"></i> Lembaga Desa</a>
                    </div>
                </div>
