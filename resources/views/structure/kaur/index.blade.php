    ...
    <div class="row">
        ...
        <div class="col mb-4">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <a href="{{ route('kaur.create') }}" class="btn btn-primary mb-3">{{ __('Data Kaur Baru') }}</a>
                        ...
                        <tbody>
                            @foreach ($results as $record)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a href="{{ route('kaur.show', $record->id) }}" class="btn btn-sm btn-secondary mr-2">{{__('Lihat')}}</a>
                                            <a href="{{ route('kaur.edit', $record->id) }}" class="btn btn-sm btn-primary mr-2">{{__('Ubah')}}</a>
...
@push('js')
    <script>
        $('.btn-hapus').click(function() {
            ...
            $("#deleteForm").attr('action', '/kaur/' + idHapus);
        })
