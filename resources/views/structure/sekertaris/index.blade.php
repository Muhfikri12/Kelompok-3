    ...
    <div class="row">
        ...
        <div class="col mb-4">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <a href="{{ route('sekertaris.create') }}"
                        class="btn btn-primary mb-3">{{ __('Data Sekertaris Baru') }}</a>
                            ...
                            <tbody>
                                @foreach ($results as $record)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ route('sekertaris.show', $record->id) }}"
                                                    class="btn btn-sm btn-secondary mr-2">{{ __('Lihat') }}</a>
                                                <a href="{{ route('sekertaris.edit', $record->id) }}"
