                            ...
                            <div class="card m-2">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between mb-2">
                                        <h5 class="card-title d-flex justify-content-start ">{{ $record->name ?? '' }}
                                        </h5>
                                        <h5 class="card-title d-flex justify-content-end">{{ $record->type ?? '' }}
                                        </h5>
                                    </div>
                                    <table
                                        style="font-size:16px; border-collapse:collapse; text-align:left; text-indent:2px;">
                                        <tr>
                                            <td>
                                                Ketua
                                            </td>
