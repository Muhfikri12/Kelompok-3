        ...
        <hr>
            <table>
                <tr>
                    ...
                    <td><input disabled type="text" id="event_article" name="event_article" value="{{ $articles->title }}"></td>
                </tr>
                <tr>
                    <td><label for="headline_article">Headline Acara</label></td>
                    <td><input disabled type="text" id="headline_article" name="headline_article"
                            value="{{ $articles->content }}" required> <br></td>
                </tr>
                <tr>
                    <td><label for="event_time">Waktu Pelaksanaan</label></td>
                    <td><input disabled type="text" id="event_time" name="event_time" required
                            value="{{ $articles->event_time }}"> <br></td>
                </tr>
                <tr>
                    <td><label for="event_date">Tanggal Pelaksanaan</label></td>
                    <td><input disabled type="date" id="event_date" name="event_date" required
                            value="{{ \Carbon\Carbon::parse($articles->event_date)->format('Y-m-d') }}"></td>
                </tr>
                <tr>
                    <td><label for="event_place">Tempat Pelaksanaan</label></td>
                    <td><input disabled type="type" id="event_place" name="event_place" required
